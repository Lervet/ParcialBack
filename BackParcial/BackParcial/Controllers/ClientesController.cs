...
namespace BackParcial.Controllers
{
    ...
    public class ClientesController : ControllerBase
    {
        ...
        public ClientesController(ParcialContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Cliente>> PostCliente(Cliente cliente)
        {
          if (_context.Clientes == null)
          {
              return Problem("Entity set 'ParcialContext.Clientes'  is null.");
          }
            _context.Clientes.Add(cliente);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetCliente", new { id = cliente.IdClientes }, cliente);
        }
