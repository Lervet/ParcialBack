...
namespace BackParcial.Controllers
{
    ...
    public class FarmaciasController : ControllerBase
    {
        ...
        public FarmaciasController(ParcialContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Farmacia>> PostFarmacia(Farmacia farmacia)
        {
          if (_context.Farmacias == null)
          {
              return Problem("Entity set 'ParcialContext.Farmacias'  is null.");
          }
            _context.Farmacias.Add(farmacia);
            await _context.SaveChangesAsync();

            return CreatedAtAction("GetFarmacia", new { id = farmacia.IdFarmacias }, farmacia);
        }
        ...
        {
            return (_context.Farmacias?.Any(e => e.IdFarmacias == id)).GetValueOrDefault();
        }
    }
}
